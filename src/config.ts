...
export const MONSTER_DATABASE: MonsterTemplate[] = [
  ...
  { symbol: 'K↑', name: 'Kalius King Cobra', hp: 65, atk: 15, color: '#cd853f', minFloor: 6 },
  { symbol: 'I', name: 'Indus Worm', hp: 51, atk: 18, color: '#f5f5dc', minFloor: 7 },
  { symbol: 'P', name: 'Pygmy', hp: 58, atk: 22, color: '#d2b48c', minFloor: 8 },
  { symbol: 'P↑', name: 'Pantier Pygmy King', hp: 72, atk: 22, color: '#d2b48c', minFloor: 8 },
  ...
  { symbol: 'M↑', name: 'Michael the Minotaur', hp: 96, atk: 32, color: '#8b4513', minFloor: 11 },
  ...
  { symbol: 'T↑', name: 'Trogdor the Troll', hp: 150, atk: 37, color: '#00ff00', minFloor: 14 },
  { symbol: 'G', name: 'Golem', hp: 155, atk: 39, color: '#d2b48c', minFloor: 15 },
  { symbol: 'G↑', name: 'Gary the Golem', hp: 170, atk: 41, color: '#d2b48c', minFloor: 15 },
  { symbol: 'F', name: 'Flying Serpent', hp: 178, atk: 42, color: '#39ff14', minFloor: 16 },
  { symbol: 'C', name: 'Cyclops', hp: 205, atk: 43, color: '#ffdab9', minFloor: 17 },
  { symbol: 'C↑', name: 'Colossal Cyclops', hp: 225, atk: 45, color: '#ffdab9', minFloor: 17 },
  ...
  { symbol: 'Z↑', name: 'Zachary the Zombie', hp: 300, atk: 51, color: '#00ff00', minFloor: 19 },
